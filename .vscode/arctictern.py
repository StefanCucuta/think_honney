...
BASE_URL = "https://raw.githubusercontent.com/Code-Institute-Org/\
...
def start_migration():
    ...
    if MIGRATE and os.path.isdir(".vscode"):
        ...
        if input("Overwrite? Y/N ").lower() == "y":
            ...
            print("You will need to manually remove the .theia\
...
if __name__ == "__main__":
    ...
    if not MIGRATE:
        print("If the --migrate switch is provided, the\
             repo will be migrated from Theia to VS Code")
